...
//todo split util.cpp
class VolumeGUI : public OgreBites::ApplicationContext, public OgreBites::InputListenerChain, public OgreBites::TrayListener
{
public:
    VolumeGUI(std::shared_ptr<std::vector<CameraWrapper>> cameras_,
    ...
    std::shared_ptr<VolumeSingleton> VolumeManager;
    ...
    Ogre::ManualObject *RecordedObjectPointer; //memory managed by scene manager
    std::shared_ptr<open3d::geometry::PointCloud> RecordedAndCroppedPcd;
    void SiloSliderFunction();
    ...
    void SaveSliderValues(VolumeSingleton &vol);
    ...
    std::shared_ptr<open3d::geometry::TriangleMesh>  CameraModels;
